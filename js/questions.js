var QUESTIONS = [
		 ...
		 'hint' : "<p>Never underestimate the value of good communication skills. Generating bug reports is a huge part of any tester’s job. Being able to create concise, easily readable bug reports is essential to be done in timely manner.</p>"
		 },
		 {
		 'id' : 12,
		 'text' : "How would you test a toaster?",
		 'hint' : "<p>Another staple of QA testing interviews, this question is designed to see how you approach a problem. The interviewer might replace toaster withrun on battery backup, etc.</p>"
		 },
		 {
		 'id' : 13,
